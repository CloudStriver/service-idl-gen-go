...
func (x *FileInfo) fastWriteField13(buf []byte) (offset int) {
	...
	offset += fastpb.WriteMessage(buf[offset:], 13, x.GetAuthor())
	return offset
}
...
func (x *FileInfo) fastWriteField14(buf []byte) (offset int) {
	...
	offset += fastpb.WriteMessage(buf[offset:], 14, x.GetFileCount())
	return offset
}
...
func (x *FileInfo) fastWriteField15(buf []byte) (offset int) {
	...
	offset += fastpb.WriteMessage(buf[offset:], 15, x.GetFileRelation())
	return offset
}
...
func (x *FileFilterOptions) fastWriteField8(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 8, x.GetOnlySetRelation())
	return offset
}
...
func (x *FileFilterOptions) fastWriteField9(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 9, x.GetOnlyMd5())
	return offset
}
...
func (x *Post) fastWriteField7(buf []byte) (offset int) {
	...
	offset += fastpb.WriteMessage(buf[offset:], 7, x.GetAuthor())
	return offset
}
...
func (x *FileInfo) sizeField13() (n int) {
	...
	n += fastpb.SizeMessage(13, x.GetAuthor())
	return n
}
...
func (x *FileInfo) sizeField14() (n int) {
	...
	n += fastpb.SizeMessage(14, x.GetFileCount())
	return n
}
...
func (x *FileInfo) sizeField15() (n int) {
	...
	n += fastpb.SizeMessage(15, x.GetFileRelation())
	return n
}
...
func (x *FileFilterOptions) sizeField8() (n int) {
	...
	n += fastpb.SizeInt64(8, x.GetOnlySetRelation())
	return n
}
...
func (x *FileFilterOptions) sizeField9() (n int) {
	...
	n += fastpb.SizeString(9, x.GetOnlyMd5())
	return n
}
...
func (x *Post) sizeField7() (n int) {
	...
	n += fastpb.SizeMessage(7, x.GetAuthor())
	return n
}
