...
type Post struct {
	...
	Url          string        `protobuf:"bytes,6,opt,name=url,proto3" json:"url,omitempty"`
	Author       *User         `protobuf:"bytes,7,opt,name=author,proto3" json:"author,omitempty"`             // 作者信息
	PostCount    *PostCount    `protobuf:"bytes,8,opt,name=postCount,proto3" json:"postCount,omitempty"`       // 文章统计信息
	PostRelation *PostRelation `protobuf:"bytes,9,opt,name=postRelation,proto3" json:"postRelation,omitempty"` // 文章关系信息
...
var file_cloudmind_core_api_common_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x6c, 0x12, 0x30, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x07, 0x20,
	...
	0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x3b, 0x0a, 0x09, 0x70, 0x6f, 0x73, 0x74, 0x43, 0x6f, 0x75,
