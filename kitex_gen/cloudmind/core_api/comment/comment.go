...
func setCommentSubjectStateHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(core_api.SetCommentSubjectStateReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(core_api.Comment).SetCommentSubjectState(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SetCommentSubjectStateArgs:
		success, err := handler.(core_api.Comment).SetCommentSubjectState(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *SetCommentSubjectStateArgs) Unmarshal(in []byte) error {
	msg := new(core_api.SetCommentSubjectStateReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var SetCommentSubjectStateArgs_Req_DEFAULT *core_api.SetCommentSubjectStateReq

func (p *SetCommentSubjectStateArgs) GetReq() *core_api.SetCommentSubjectStateReq {
	if !p.IsSetReq() {
...
type SetCommentSubjectStateResult struct {
	Success *core_api.SetCommentSubjectStateResp
}

var SetCommentSubjectStateResult_Success_DEFAULT *core_api.SetCommentSubjectStateResp

func (p *SetCommentSubjectStateResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(core_api.SetCommentSubjectStateResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *SetCommentSubjectStateResult) Unmarshal(in []byte) error {
	msg := new(core_api.SetCommentSubjectStateResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *SetCommentSubjectStateResult) GetSuccess() *core_api.SetCommentSubjectStateResp {
	if !p.IsSetSuccess() {
...
func (p *SetCommentSubjectStateResult) SetSuccess(x interface{}) {
	p.Success = x.(*core_api.SetCommentSubjectStateResp)
}
...
func setCommentSubjectAttrsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(core_api.SetCommentSubjectAttrsReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(core_api.Comment).SetCommentSubjectAttrs(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *SetCommentSubjectAttrsArgs:
		success, err := handler.(core_api.Comment).SetCommentSubjectAttrs(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *SetCommentSubjectAttrsArgs) Unmarshal(in []byte) error {
	msg := new(core_api.SetCommentSubjectAttrsReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var SetCommentSubjectAttrsArgs_Req_DEFAULT *core_api.SetCommentSubjectAttrsReq

func (p *SetCommentSubjectAttrsArgs) GetReq() *core_api.SetCommentSubjectAttrsReq {
	if !p.IsSetReq() {
...
type SetCommentSubjectAttrsResult struct {
	Success *core_api.SetCommentSubjectAttrsResp
}

var SetCommentSubjectAttrsResult_Success_DEFAULT *core_api.SetCommentSubjectAttrsResp

func (p *SetCommentSubjectAttrsResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(core_api.SetCommentSubjectAttrsResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *SetCommentSubjectAttrsResult) Unmarshal(in []byte) error {
	msg := new(core_api.SetCommentSubjectAttrsResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *SetCommentSubjectAttrsResult) GetSuccess() *core_api.SetCommentSubjectAttrsResp {
	if !p.IsSetSuccess() {
...
func (p *SetCommentSubjectAttrsResult) SetSuccess(x interface{}) {
	p.Success = x.(*core_api.SetCommentSubjectAttrsResp)
}
...
func (p *kClient) SetCommentSubjectState(ctx context.Context, Req *core_api.SetCommentSubjectStateReq) (r *core_api.SetCommentSubjectStateResp, err error) {
...
func (p *kClient) SetCommentSubjectAttrs(ctx context.Context, Req *core_api.SetCommentSubjectAttrsReq) (r *core_api.SetCommentSubjectAttrsResp, err error) {
