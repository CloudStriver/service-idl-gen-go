...
func (x *CreateRelationReq) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 2, int32(x.GetToType()))
	return offset
}
...
func (x *CreateRelationReq) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 3, int32(x.GetRelationType()))
	return offset
}
...
func (x *CreateRelationReq) sizeField2() (n int) {
	...
	n += fastpb.SizeInt32(2, int32(x.GetToType()))
	return n
}
...
func (x *CreateRelationReq) sizeField3() (n int) {
	...
	n += fastpb.SizeInt32(3, int32(x.GetRelationType()))
	return n
}
