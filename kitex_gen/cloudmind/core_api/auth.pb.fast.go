...
func (x *RegisterReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	...
	x.RegisterType = RegisterType(v)
	return offset, nil
}

func (x *RegisterReq) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.AuthKey, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *RegisterReq) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 3, int32(x.GetRegisterType()))
	return offset
}
...
func (x *RegisterReq) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 4, x.GetAuthKey())
	return offset
}
...
func (x *RegisterReq) sizeField3() (n int) {
	...
	n += fastpb.SizeInt32(3, int32(x.GetRegisterType()))
	return n
}
...
func (x *RegisterReq) sizeField4() (n int) {
	...
	n += fastpb.SizeString(4, x.GetAuthKey())
	return n
}
