...
var fileServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "file"
	handlerType := (*content.File)(nil)
...
func getCosInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetCosInfo(ctx, req)
		if err != nil {
			return err
		}
	...
	case *GetCosInfoArgs:
		success, err := handler.(content.File).GetCosInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileByMd5Handler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileByMd5(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileByMd5Args:
		success, err := handler.(content.File).GetFileByMd5(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileInfoByFileIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileInfoByFileId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileInfoByFileIdArgs:
		success, err := handler.(content.File).GetFileInfoByFileId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileByFileIdWithUserIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileByFileIdWithUserId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileByFileIdWithUserIdArgs:
		success, err := handler.(content.File).GetFileByFileIdWithUserId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileInfoByFileIdsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileInfoByFileIds(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileInfoByFileIdsArgs:
		success, err := handler.(content.File).GetFileInfoByFileIds(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileInfoByFileIdsWithUserIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileInfoByFileIdsWithUserId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileInfoByFileIdsWithUserIdArgs:
		success, err := handler.(content.File).GetFileInfoByFileIdsWithUserId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFilesByFatherIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFilesByFatherId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFilesByFatherIdArgs:
		success, err := handler.(content.File).GetFilesByFatherId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFilesByFatherIdWithUserIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFilesByFatherIdWithUserId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFilesByFatherIdWithUserIdArgs:
		success, err := handler.(content.File).GetFilesByFatherIdWithUserId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getAllFileByFatherIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetAllFileByFatherId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetAllFileByFatherIdArgs:
		success, err := handler.(content.File).GetAllFileByFatherId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileCountHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileCount(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileCountArgs:
		success, err := handler.(content.File).GetFileCount(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileTypeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileType(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileTypeArgs:
		success, err := handler.(content.File).GetFileType(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileInfoInPublicByFileIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileInfoInPublicByFileId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileInfoInPublicByFileIdArgs:
		success, err := handler.(content.File).GetFileInfoInPublicByFileId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getPublicFileByFileIdWithUserIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetPublicFileByFileIdWithUserId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetPublicFileByFileIdWithUserIdArgs:
		success, err := handler.(content.File).GetPublicFileByFileIdWithUserId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getPublicByFileIdsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetPublicByFileIds(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetPublicByFileIdsArgs:
		success, err := handler.(content.File).GetPublicByFileIds(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getPublicFilesByUserIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetPublicFilesByUserId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetPublicFilesByUserIdArgs:
		success, err := handler.(content.File).GetPublicFilesByUserId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getPublicFilesByFatherIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetPublicFilesByFatherId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetPublicFilesByFatherIdArgs:
		success, err := handler.(content.File).GetPublicFilesByFatherId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getAllPublicFileByFatherIdHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetAllPublicFileByFatherId(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetAllPublicFileByFatherIdArgs:
		success, err := handler.(content.File).GetAllPublicFileByFatherId(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFileBySharingCodeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).GetFileBySharingCode(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFileBySharingCodeArgs:
		success, err := handler.(content.File).GetFileBySharingCode(ctx, s.Req)
		if err != nil {
			return err
		}
...
func calFileSizeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).CalFileSize(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CalFileSizeArgs:
		success, err := handler.(content.File).CalFileSize(ctx, s.Req)
		if err != nil {
			return err
		}
...
func calPublicFileSizeHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).CalPublicFileSize(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CalPublicFileSizeArgs:
		success, err := handler.(content.File).CalPublicFileSize(ctx, s.Req)
		if err != nil {
			return err
		}
...
func uploadFileHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).UploadFile(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UploadFileArgs:
		success, err := handler.(content.File).UploadFile(ctx, s.Req)
		if err != nil {
			return err
		}
...
func askUploadFileHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).AskUploadFile(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *AskUploadFileArgs:
		success, err := handler.(content.File).AskUploadFile(ctx, s.Req)
		if err != nil {
			return err
		}
...
func askUploadFileRollbackHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).AskUploadFileRollback(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *AskUploadFileRollbackArgs:
		success, err := handler.(content.File).AskUploadFileRollback(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteExpiredFilesHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).DeleteExpiredFiles(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteExpiredFilesArgs:
		success, err := handler.(content.File).DeleteExpiredFiles(ctx, s.Req)
		if err != nil {
			return err
		}
...
func deleteExpiredShareCodesHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(content.File).DeleteExpiredShareCodes(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *DeleteExpiredShareCodesArgs:
		success, err := handler.(content.File).DeleteExpiredShareCodes(ctx, s.Req)
		if err != nil {
			return err
		}
