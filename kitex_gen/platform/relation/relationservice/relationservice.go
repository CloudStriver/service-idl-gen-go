...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"GetRelations": kitex.NewMethodInfo(
		getRelationsHandler,
		newGetRelationsArgs,
		newGetRelationsResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
	"GetRelationCount": kitex.NewMethodInfo(
		getRelationCountHandler,
		newGetRelationCountArgs,
		newGetRelationCountResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
